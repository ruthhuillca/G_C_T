...
int main()
{
	...
	int gt[5][5] = { {1, 4, 6, 4, 1}, {4, 16, 24, 16, 4}, {6, 24, -476, 24, 6}, {4, 16, 24, 16, 4}, {1, 4, 6, 4, 1},};
	...
	IF smooth = convolution<5>(img,gt,5);
	...
	cout<<"========================================================"<<endl;
	std::cout << "Tiempo Secuencial  " << std::chrono::duration_cast<std::chrono::milliseconds>(time).count() << " to run.\n";	
	cout<<"========================================================"<<endl;
...
// g++ convolution.cpp -lm -lpthread -lX11 -std=c++11
// ./a.out